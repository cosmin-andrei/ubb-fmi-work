...
void uiModify(Tranzactii* store) {
    int ziua, luna, suma;
...
void uiDelete(Tranzactii* store) {
    int ziua, luna;
    char descriere[30];
    char temp;
    scanf_s("%c", &temp, 1);
...
void uiFilterbySuma(Tranzactii* store) {
    int suma;
    char temp;
    scanf_s("%c", &temp, 1);
    printf("Suma este:");
...
void uiFilterbyTip(Tranzactii* store) {
    char tip[8];
    char temp;
    scanf_s("%c", &temp, 1);
    printf("Tipul este:");
...
void uiSortBySuma(Tranzactii* store) {

    int way;
    printf("Crescator(1)/Descrescator(2):");
    scanf_s("%d", &way);
    MyList* sortedList;
    if (way == 1) sortedList = sortTranzactiiBySuma(store);
    else sortedList = sortTranzactiiBySumaR(store);
    printAll(sortedList);
    destroyList(sortedList);
}

void uiSortByZi(Tranzactii* store) {

    int way;
    printf("Crescator(1)/Descrescator(2):");
    scanf_s("%d", &way);
    MyList* sortedList;
    if (way == 1) sortedList = sortTranzactiiByZi(store);
    else sortedList = sortTranzactiiByZiR(store);
    printAll(sortedList);
    destroyList(sortedList);
}
