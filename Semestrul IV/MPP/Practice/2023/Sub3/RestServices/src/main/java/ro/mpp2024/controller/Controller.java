...
import ro.mpp2024.repository.RundaRepoInterface;
...
public class Controller {
    ...
    public ResponseEntity<?> getById(@PathVariable Long id) {
        ...
        Optional<Runda> runda = repo.findOne(id);
        return runda.map(c -> ResponseEntity.ok().body(c))
    ...
    public Runda create(@RequestBody Runda runda) {
        ...
        Optional<Runda> result = repo.save(runda);
