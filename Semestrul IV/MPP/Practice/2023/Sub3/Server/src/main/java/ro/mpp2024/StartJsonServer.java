...
public class StartJsonServer {
    ...
    public static void main(String[] args) {
        ...
        CuvantRepoInterface cuvantRepo = new CuvantRepo(serverProps);
        RundaRepoInterface rundaRepo = new RundaRepo(serverProps);
        IServices service = new ServicesImpl(voluntarRepo, cuvantRepo, rundaRepo);
