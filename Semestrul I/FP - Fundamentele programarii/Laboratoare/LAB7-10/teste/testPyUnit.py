...
class Testare(unittest.TestCase):
    ...
    def __ServiceTests(self):
        ...
        self.service.adauga_student(1, "Cosmin", 211)
        self.service.adauga_student(2, "Adrian", 213)
        ...
        self.service.adauga_laborator_service(2,"enunt2", 2, 10, 2023)
        self.assertEqual(len(self.service.get_all()), 2)
        ...
        self.assertEqual(len(self.service.get_all()),0)
        self.service.adauga_nota(1,1,1,8)
        self.assertEqual(self.service.get_all(), [Nota(1,1,1,8)])

        self.service.adauga_nota(2, 1, 2, 8)
        self.service.adauga_nota(4, 2, 1, 4)
        self.service.adauga_nota(5, 2, 2, 1)

        self.assertEqual(len(self.service.studenti_restantieri()),1)
        self.assertEqual(self.service.nota_frecventa(),  8)
