...
/* Line 189 of yacc.c  */
#line 1 "D:/Facultate/ubb-fmi-work/SemestrulV/LTFC/Tema 6/analizator.y"
...
/* Line 214 of yacc.c  */
#line 33 "D:/Facultate/ubb-fmi-work/SemestrulV/LTFC/Tema 6/analizator.y"
...
{
       0,     0,     3,    12,    15,    18,    22,    27,    29,    32,
      34,    36,    38,    40,    45,    50,    55,    60,    62,    66,
      68,    70,    72,    74,    76
};
...
{
      26,     0,    -1,     3,     4,     7,    21,    15,    27,    29,
      16,    -1,     7,    28,    -1,    23,    14,    -1,    23,    13,
      28,    -1,    30,    22,    24,    14,    -1,    31,    -1,    31,
      30,    -1,    32,    -1,    35,    -1,    33,    -1,    34,    -1,
       5,    17,    23,    14,    -1,     6,    18,    23,    14,    -1,
       6,    18,    24,    14,    -1,    23,    12,    36,    14,    -1,
      38,    -1,    38,    37,    36,    -1,     8,    -1,     9,    -1,
      10,    -1,    11,    -1,    23,    -1,    24,    -1
};
...
{
       0,    63,    63,    68,    71,    80,    91,    94,    95,    98,
      99,   102,   103,   106,   129,   145,   162,   175,   176,   187,
     188,   189,   190,   193,   194
};
#endif
...
{
  "$end", "error", "$undefined", "INCLUDE", "NAMESPACE", "ISTREAM",
  "OSTREAM", "DATA_TYPE", "PLUS", "MINUS", "OR", "DIVIDE", "ASSIGN",
  "COMMA", "SEMICOLON", "LAQ", "RAQ", "SIN", "SOUT", "LPR", "RPR", "MAIN",
  "RETURN", "ID", "CONST", "$accept", "program", "declare_instruction",
  "declaration", "code_block", "instruction_list", "instruction",
  "io_instruction", "input_instruction", "output_instruction",
  "assign_instruction", "operation", "operator", "any", 0
};
#endif
...
/* Line 1455 of yacc.c  */
#line 63 "D:/Facultate/ubb-fmi-work/SemestrulV/LTFC/Tema 6/analizator.y"
    {
...
/* Line 1455 of yacc.c  */
#line 71 "D:/Facultate/ubb-fmi-work/SemestrulV/LTFC/Tema 6/analizator.y"
    {
            char tmp[100];
			strcpy(tmp, " ");
			strcat(tmp, (yyvsp[(1) - (2)].value));
...
/* Line 1455 of yacc.c  */
#line 80 "D:/Facultate/ubb-fmi-work/SemestrulV/LTFC/Tema 6/analizator.y"
    {
            char tmp[100];
			strcpy(tmp, " ");
			strcat(tmp, (yyvsp[(1) - (3)].value));
			if (!found(declarations, lenDeclarations, tmp)) {
				strcpy(declarations[lenDeclarations], strcat(tmp, " times 4 db 0"));
				lenDeclarations++;
			}
...
/* Line 1455 of yacc.c  */
#line 106 "D:/Facultate/ubb-fmi-work/SemestrulV/LTFC/Tema 6/analizator.y"
    {
        n = 0;
        strcpy(variablesRead[n], "push dword ");
        strcat(variablesRead[n], (yyvsp[(3) - (4)].value));
...
/* Line 1455 of yacc.c  */
#line 129 "D:/Facultate/ubb-fmi-work/SemestrulV/LTFC/Tema 6/analizator.y"
    {
        ...
        strcat(sourceCode[lenSourceCode], (yyvsp[(3) - (4)].value));
...
/* Line 1455 of yacc.c  */
#line 145 "D:/Facultate/ubb-fmi-work/SemestrulV/LTFC/Tema 6/analizator.y"
    {
        if (!found(imports, lenImports, "printf")) {
            strcpy(imports[lenImports], "printf");
            lenImports++;
...
/* Line 1455 of yacc.c  */
#line 162 "D:/Facultate/ubb-fmi-work/SemestrulV/LTFC/Tema 6/analizator.y"
    {
        char tmp[MAX];
        strcpy(tmp, (yyvsp[(3) - (4)].value));
        ...
        parseExpression((yyvsp[(1) - (4)].value));
    ;}
    break;
...
/* Line 1455 of yacc.c  */
#line 176 "D:/Facultate/ubb-fmi-work/SemestrulV/LTFC/Tema 6/analizator.y"
    {
        char tmp[MAX];
        strcpy(tmp, (yyvsp[(1) - (3)].value));
        strcat(tmp, " ");
        strcat(tmp, (yyvsp[(2) - (3)].value));
        strcat(tmp, " ");
        strcat(tmp, (yyvsp[(3) - (3)].value));
...
/* Line 1675 of yacc.c  */
#line 197 "D:/Facultate/ubb-fmi-work/SemestrulV/LTFC/Tema 6/analizator.y"
