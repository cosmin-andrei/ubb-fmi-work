...
import com.example.myapp3.sensor.DeviceSensors
...
fun ItemsScreen(onItemClick: (id: String?) -> Unit, onAddItem: () -> Unit, onLogout: () -> Unit){
    ...
    Scaffold (
        ...
        Column(modifier = Modifier.padding(8.dp)) {
            Text(text = "Proximity Sensor State:", modifier = Modifier.padding(8.dp))
            ProximitySensor(modifier = Modifier.padding(8.dp))
        }
    }
}
