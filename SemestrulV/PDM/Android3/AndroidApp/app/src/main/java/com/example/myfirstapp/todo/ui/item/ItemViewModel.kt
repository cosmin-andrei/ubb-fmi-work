...
class ItemViewModel(private val itemId: String?, private val itemRepository: ItemRepository) :
    ...
    fun saveItem(title: String, description: String, participants: Int, status: Boolean, date: Date, imageUrl: String){
        viewModelScope.launch {
            try{
    ...
    fun UpdateItem(title: String, description: String, participants: Int, status: Boolean, date: Date, imageUrl: String) {
        viewModelScope.launch {
