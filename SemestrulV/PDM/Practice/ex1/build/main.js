...
const broadcast = () => {
  ...
  console.log("Broadcasting new message:", messages[messages.length - 1]);
...
router.put('/message/:id', ctx => {
  ...
  if (id !== message.id || index === -1) {
    console.log("🚨 Error in PUT /message/:id", {
      idFromUrl: id,
      idFromBody: message.id,
      index
    });
    ctx.response.body = {
...
module.exports = __webpack_require__(/*! D:\Facultate\ubb-fmi-work\SemestrulV\PDM\Practice\ex1\src/index.js */"./src/index.js");
